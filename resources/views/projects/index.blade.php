...
@section('content')
    <header class="flex items-center mb-3 py-4">
        <div class="flex justify-between items-end w-full">
            <h2 class="text-muted text-base light-normal">My projects</h2>
        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" class="border border-muted-light py-2 px-2 text-xs block w-full rounded">
                </div>

                <div class="mb-4">
                    <label for="description" class="text-sm block mb-2">Description</label>
                    <textarea id="description" class="border border-muted-light py-2 px-2 text-xs block w-full rounded" rows="7"></textarea>
                </div>
            </div>
            ...
            <div class="flex-1 ml-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="border border-muted-light py-2 px-2 text-xs block w-full rounded" placeholder="Task 1">
                </div>
